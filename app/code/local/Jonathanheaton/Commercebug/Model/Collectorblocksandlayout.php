<?php 
	class Jonathanheaton_Commercebug_Model_Collectorblocksandlayout extends Jonathanheaton_Commercebug_Model_Observingcollector
	{
		...
		{		
			...
			foreach($this->_blocks as $block)
			{
				...
				if(strpos($class,'Jonathanheaton_Commercebug') === 0)
				{
					continue;
				}
