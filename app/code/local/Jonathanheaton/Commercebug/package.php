<?php
	class Commercebug_Packager
	{
		...
		{
			$string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Jonathanheaton_Commercebug><active>true</active><codePool>local</codePool></Jonathanheaton_Commercebug></modules></config>';
			$string = str_replace('Jonathanheaton_', $this->namespace . '_',$string);
